...
public class EscapeSequences {
    ...
    public static final String SET_TEXT_COLOR_YELLOW = SET_TEXT_COLOR + "33m";
    public static final String SET_TEXT_COLOR_LIGHT_YELLOW = SET_TEXT_COLOR + "75m";
    ...
    public static final String SET_BG_COLOR_YELLOW = SET_BG_COLOR + "33m";
    public static final String SET_BG_COLOR_LIGHT_YELLOW = SET_BG_COLOR + "75m";
